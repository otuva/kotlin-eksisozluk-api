...
import com.github.otuva.eksisozluk.utils.encodeSpaces
...
public class UserApi(private val client: HttpClient, private val userType: UserType)  {
    ...
    public suspend fun get(username: String): User {
        val url = Routes.baseUrl + Routes.User.base.format(encodeSpaces(username))
    ...
    public suspend fun entries(username: String, page: Int = 1): UserEntries? {
        val url = Routes.baseUrl + Routes.User.entries.format(encodeSpaces(username)) + "?p=$page"
    ...
    public suspend fun favoriteEntries(username: String, page: Int = 1): UserEntries? {
        val url = Routes.baseUrl + Routes.User.favorites.format(encodeSpaces(username)) + "?p=$page"
    ...
    public suspend fun mostFavoritedEntries(username: String, page: Int = 1): UserEntries? {
        val url = Routes.baseUrl + Routes.User.favorited.format(encodeSpaces(username)) + "?p=$page"
    ...
    public suspend fun lastVotedEntries(username: String, page: Int = 1): UserEntries? {
        val url = Routes.baseUrl + Routes.User.lastVoted.format(encodeSpaces(username)) + "?p=$page"
    ...
    public suspend fun lastWeekMostVotedEntries(username: String, page: Int = 1): UserEntries? {
        val url = Routes.baseUrl + Routes.User.lastWeekMostVoted.format(encodeSpaces(username)) + "?p=$page"
    ...
    public suspend fun selfFavoritedEntries(username: String, page: Int = 1): UserEntries? {
        val url = Routes.baseUrl + Routes.User.selfFavorited.format(encodeSpaces(username)) + "?p=$page"
    ...
    public suspend fun bestEntries(username: String, page: Int = 1): UserEntries? {
        val url = Routes.baseUrl + Routes.User.bestEntries.format(encodeSpaces(username)) + "?p=$page"
    ...
    public suspend fun images(username: String, page: Int = 1): UserImages {
        val url = Routes.baseUrl + Routes.User.images.format(encodeSpaces(username)) + "?p=$page"
